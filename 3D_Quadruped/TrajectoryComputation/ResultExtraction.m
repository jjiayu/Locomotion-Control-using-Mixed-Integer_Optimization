...
%Sequence is consistent with the programming
gait = [Clf_result,...
        Clh_result,...
        Crf_result,...
        Crh_result,...
...
warning('NOTE 3: "gait" is the SOLELY variable name storing the gait sequence which is consistent with respect to the optimization program')
