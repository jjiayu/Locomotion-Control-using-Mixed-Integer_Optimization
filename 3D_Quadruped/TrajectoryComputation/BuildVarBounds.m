...
%       phi
lb_phi = repmat(-pi, 1, VarLengthList(VarCategoryList == "phi"));    
ub_phi = repmat( pi, 1, VarLengthList(VarCategoryList == "phi"));
...
%       psi
lb_psi = repmat(-pi, 1, VarLengthList(VarCategoryList == "psi"));    
ub_psi = repmat( pi, 1, VarLengthList(VarCategoryList == "psi")); 
