...
for strideperiod_index = 1:length(StridePeriodVector)
    ...
    for speed_index = 1:length(SpeedVector)  
        ...
        fprintf(fid, strcat('export ParamFileDir=/home/s1545529/Eddie_3D_ANYmal_Gait_Dsicovery/',num2str(PhaseNum),'Phases','/','Phaselb_',num2str(PhaselbPercent),'_Percent','/',BoundingBoxTypeName,'_KineBox','/',num2str(TerrainSlope),'_Degrees','/',num2str(CostType),'_',costname,'/','StridePeriod_',num2str(strideperiod),'\n'));
        fprintf(fid, '\n');
