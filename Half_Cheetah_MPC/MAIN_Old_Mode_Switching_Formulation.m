% Half-Cheetah Motion Optimization based on Mixed-integer Optimization Old
% Mode Switching Formulation
...
% z: vertical position
% theta: orientation
% PFx: x position of front leg in WORLD FRAME
% PFz: z position of front leg in WORLD FRAME
% PHx: x position of hind leg in WORLD FRAME
% PHz: z position of hind leg in WORLD FRAME
%
