function result = nlconstraint_baron(vars,...
                                      NumPhases,...
                                      NumLocalKnots,...
                                      tauStepLength,...
                                      m,...
...
%-------------------------------------------------------------------------
%       Front Leg:
PFx_RobotFrame = cosTalor(theta_full).*(PFx_full - x_full) + sinTaylor(theta_full).*(PFy_full - y_full);
PFy_RobotFrame = -sinTaylor(theta_full).*(PFx_full - x_full) + cosTalor(theta_full).*(PFy_full - y_full);
...
%-------------------------------------------------------------------------
%       Hind Leg:
PHx_RobotFrame = cosTalor(theta_full).*(PHx_full - x_full) + sinTaylor(theta_full).*(PHy_full - y_full);
PHy_RobotFrame = -sinTaylor(theta_full).*(PHx_full - x_full) + cosTalor(theta_full).*(PHy_full - y_full);
%           Kinematics Constraint 1:
...
%inequality constraint to be >= type
result = [-c;ceq];
