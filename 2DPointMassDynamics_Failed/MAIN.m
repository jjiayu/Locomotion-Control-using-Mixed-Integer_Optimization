% Mixed-Integer Nonlinear Optimization for 2D Ponit Mass Moving (Traslational Dynamics for Half-Cheetah)
...
Ainit = [Ax_init;Ay_init;Axdot_init;Aydot_init];
%           Build b vectors
binit = [x_init;y_init;xdot_init;ydot_init];
%---------------------------------------------------------------
%       Terminal State
%           Build A matrix
...
Aend = [Ax_end;Ay_end;Axdot_end;Aydot_end];
%           Build b vectors
bend = [x_end;y_end;xdot_end;ydot_end];
%---------------------------------------------------------------
%===============================================================
%Build Constraints
%===============================================================
