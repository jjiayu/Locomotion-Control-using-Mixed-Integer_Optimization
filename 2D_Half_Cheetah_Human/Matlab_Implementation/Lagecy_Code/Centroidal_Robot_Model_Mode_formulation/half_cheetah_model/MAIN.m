...
for i = 1:xdotLength-1
    ...
    AxdotModeHindLeq(i,find(names==strcat('FFx',num2str(i))))=-TimeStep/2/m;
    AxdotModeHindLeq(i,find(names==strcat('FHx',num2str(i))))=0;
    AxdotModeHindLeq(i,find(names==strcat('FFx',num2str(i-1))))=-TimeStep/2/m;
    AxdotModeHindLeq(i,find(names==strcat('FHx',num2str(i-1))))=0;
...
for i = 1:xdotLength-1
    ...
    AxdotModeHindGeq(i,find(names==strcat('FFx',num2str(i))))=-TimeStep/2/m;
    AxdotModeHindGeq(i,find(names==strcat('FHx',num2str(i))))=0;
    AxdotModeHindGeq(i,find(names==strcat('FFx',num2str(i-1))))=-TimeStep/2/m;
    AxdotModeHindGeq(i,find(names==strcat('FHx',num2str(i-1))))=0;
