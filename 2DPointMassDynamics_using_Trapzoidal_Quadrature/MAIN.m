...
Mpos_y = 100; %big-M for Foot position in y-axis
Mvel = 100; %big-M for Foot velocity in both x and y axis
...
subplot(3,2,3)
plot(TimeSeries,result.x(find(names == 'PFxdot0'):find(names == PFxdot_label(end))),'LineWidth',2)
...
subplot(3,2,4)
plot(TimeSeries,result.x(find(names == 'PHxdot0'):find(names == PHxdot_label(end))),'LineWidth',2)
...
subplot(3,2,5)
plot(TimeSeries,result.x(find(names == 'PFydot0'):find(names == PFydot_label(end))),'LineWidth',2)
...
subplot(3,2,6)
plot(TimeSeries,result.x(find(names == 'PHydot0'):find(names == PHydot_label(end))),'LineWidth',2)
