...
lb_DecisionVars = [repmat(-inf,1,sum(VarLengthList(find(varList == 'x'):find(varList == 'FHy')))), zeros(1,sum(VarLengthList(find(varList == 'CF'):find(varList == 'CH'))))];
ub_DecisionVars = [repmat( inf,1,sum(VarLengthList(find(varList == 'x'):find(varList == 'FHy')))), ones(1,sum(VarLengthList(find(varList == 'CF'):find(varList == 'CH'))))];
